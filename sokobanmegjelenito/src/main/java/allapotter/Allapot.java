...
public class Allapot {
    ...
    public Allapot(Allapot allapot) {
        ...
        this.allapot_tomb=uj_allapot_tomb;
        this.utoljara_mozgatott_lada_x=allapot.utoljara_mozgatott_lada_x;
        this.utoljara_mozgatott_lada_y=allapot.utoljara_mozgatott_lada_y;
    }

    public int[][] getAllapot_tomb() {
        return allapot_tomb;
    }

    public int getUtoljara_mozgatott_lada_x() {
        return utoljara_mozgatott_lada_x;
    }

    public int getUtoljara_mozgatott_lada_y() {
        return utoljara_mozgatott_lada_y;
    }

    public void setVegallapot(int vegallapot) {
    ...
    public double heurisztika(){
        ...
        return (20 - (double) temp/100) + lada_a_celon;
    }
